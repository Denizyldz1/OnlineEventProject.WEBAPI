...
using OnlineEvent.Service.Mapping.Exceptions;
using System.Text.Json;

namespace OnlineEvent.API.Middlewares
{
		...
		public static void UseCustomException(this IApplicationBuilder app)
		{
			app.UseExceptionHandler(config =>
			{
				...
				config.Run(async context =>
				{
					...
					var response = CustomResponseModel<NoContentModel>.Failure(statusCode, errorMessage);
